#include <stdio.h>
int main (){
const size_t size = 25; /* створили константу - розмір. Якщо ми б її не створили, то в кожному з циклів ми були б змушені писати 25, що не лише непотрібно, але й погано з точки зору зрозумілості та гнучкості коду. У даному випадку для зміни розміру масивів потрібно переписати лише один рядок коду .*/
