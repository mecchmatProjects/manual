...
int main (){
   ...
   std::cout<<"set size:"<< second_set.size()<<endl;
   std::cout<<"set max size:"<< second_set.max_size()<<endl;
   std::cout<<"how many of 20 there "<< second_set.count(20)<< " of " << *second_set.find(20)<<endl;
   std::cout<<"how many of 50 there "<< second_set.count(50)<<" of " << *second_set.find(50)<<endl;
   std::cout<<"equal range for 20: " << *second_set.equal_range(20).first << ", " << *second_set.equal_range(20).second<<endl;
...
// remove all elements up to 30 in  
  ...
  std::cout << "seventh_set.lower_bound(40) : "<< *seventh_set.lower_bound(40) << endl; 
  std::cout << "seventh_set.upper_bound(40) : "<< *seventh_set.upper_bound(40) << endl; 

  //lower bound and upper bound for set second_set 
  std::cout << "second_set.lower_bound(40) : "<< *second_set.lower_bound(40) << endl; 
  std::cout << "second_set.upper_bound(40) : "<< *second_set.upper_bound(40) << endl; 
} 
